...
const Login = () => {
    ...
    useEffect(() => {
        document.title = "Login - Monitize"
        if (session) {
            router.push('/Dashboard')
        }
    }, [router, session])
    return (
        <div className='text-white py-14 container mx-auto overflow-hidden h-[70vh]'>
            <h1 className='font-bold text-2xl text-center pb-10'>Login to Get Started</h1>
            <div className='flex container justify-center items-center '>
                ...
                <div className="flex flex-col gap-2 min-h-screen  p-10">
                    ...
                    <button
                        className="flex items-center text-white border border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium hover:bg-black hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 hover:invert">
                        <svg className="h-6 w-6 mr-2 " xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
